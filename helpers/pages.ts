...
export const vrPages: VrPage[] = [
  ...
  {
    name: 'Auditor Renewal Application (CHSA Renewal Program)',
    path: '/form/auditor-renewal-application-certified-health-and-safety-auditor-renewal-program',
  },
  {
    name: 'External Auditor Application (CHSA Program)',
    path: '/form/external-auditor-application-certified-health-and-safety-auditor-program',
  },
  {
    name: 'Internal Auditor Application (CHSA Program)',
    path: '/form/internal-auditor-application-certified-health-and-safety-auditor-program',
  },
  {
    name: 'Seismic Blasters Safety Training Registration',
    path: '/form/seismic-blasters-safety-training-registration-information',
  },
  ...
  { name: 'User Profile contenteditor', path: '/u/contenteditor?check_logged_in=1', role: 'contenteditor' },
  {
    ...
    path: '/user',
    role: [
      'student', 'instructor', 'companyadmin', 'provider', 'multirole',
      'evaluator', 'auditor', 'assessor', 'contenteditor',
    ],
  },
  ...
  // ── Portal: Help / FAQs ──────────────────────────────────────────────────────
  {
    ...
    role: ['student', 'instructor', 'companyadmin', 'provider', 'multirole', 'evaluator', 'auditor', 'contenteditor'],
  },
  {
    name: 'Need help (FAQs)',
    path: '/srv/faqs-portal',
    role: ['student', 'instructor', 'companyadmin', 'provider', 'multirole', 'evaluator', 'auditor', 'assessor', 'contenteditor'],
  },
  ...
  // ── Portal: Certifications ───────────────────────────────────────────────────
  {
    ...
    role: ['student', 'instructor', 'companyadmin', 'provider', 'multirole', 'auditor', 'contenteditor'],
  },
  {
  ...
  { name: 'Access Code', path: '/srv/access-code', role: ['student', 'companyadmin'] },
  {
  ...
  { name: 'Payments', path: '/srv/payments', role: ['companyadmin', 'multirole'] },
  { name: 'Invoices',  path: '/srv/invoices',  role: ['companyadmin', 'multirole'] },
  ...
  { name: 'Instructors List',     path: '/srv/instructors-list',     role: ['provider', 'multirole'] },
  { name: 'Instructor Resources', path: '/srv/instructor-resources', role: ['instructor', 'multirole'] },
  {
  ...
  { name: 'ATP Renewal', path: '/srv/atp-renewal', role: ['provider', 'multirole'] },
